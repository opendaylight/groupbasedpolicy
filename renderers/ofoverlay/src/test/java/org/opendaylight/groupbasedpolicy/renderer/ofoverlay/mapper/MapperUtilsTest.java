...
public abstract class MapperUtilsTest {
    ...
    protected static final String EPG_ID = "dummy epg id";
    protected static final String ENDPOINT_GROUP_0 = "eg0";
    protected static final String ENDPOINT_GROUP_1 = "eg1";
    protected static final String ENDPOINT_GROUP_2 = "eg2";
    private static final String DOMAIN_ID = "dummy id";
    protected final NodeId nodeId = new NodeId(NODE_ID);
    protected final NodeConnectorId nodeConnectorId = new NodeConnectorId(nodeId.getValue() + CONNECTOR_0);
    protected final L2BridgeDomainId bd = new L2BridgeDomainId("c95182ba-7807-43f8-98f7-6c7c720b7639");
    protected final EndpointGroupId eg = new EndpointGroupId("36dec84a-08c7-497b-80b6-a0035af72a12");
    protected final EndpointGroupId eg2 = new EndpointGroupId("632e5e11-7988-4eb5-8fe6-6c182d890276");
    protected final ContractId cid = new ContractId("a5874893-bcd5-46de-96af-3c8d99bedf9f");
    protected final L3ContextId l3c = new L3ContextId("2cf51ee4-e996-467e-a277-2d380334a91d");
    protected final L2FloodDomainId fd = new L2FloodDomainId("98e1439e-52d2-46f8-bd69-5136e6088771");
    protected final L2FloodDomainId ext_fd = new L2FloodDomainId("d8024f7a-b83e-11e5-9912-ba0be0483c18");
    protected final SubnetId sub = new SubnetId("4fcf8dfc-53b5-4aef-84d3-6b5586992fcb");
    protected final SubnetId sub2 = new SubnetId("c285a59f-fcb8-42e6-bf29-87ea522fd626");
    protected final SubnetId sub3 = new SubnetId("a0380d52-2a25-48ef-882c-a4d4cd9e00ec");
    protected final SubnetId ext_sub = new SubnetId("8da17ad9-3261-4dc9-bcff-928a2f73cce7");
    protected final TenantId tid = new TenantId(TENANT_ID);
    ...
    protected FlowBuilder flowBuilder(FlowId flowId, short tableId, Integer priority, Match match, Instructions instructions) {
    ...
    protected EndpointL3Builder endpointL3Builder(String ip, String insideIp, String mac, String l2, boolean ipv6) {
    ...
    protected IndexedTenant indexedTenantBuilder() {
    ...
    protected List<L2FloodDomain> l2FloodDomains() {
        SegmentationBuilder segmentationBuilder = new SegmentationBuilder();
        segmentationBuilder.setSegmentationId(1);
        List<L2FloodDomain> l2FloodDomains = new ArrayList<>();
        L2FloodDomainBuilder l2FloodDomainBuilder = new L2FloodDomainBuilder();
    ...
    protected EndpointBuilder endpointBuilder(IpAddress ip, MacAddress mac, NodeConnectorId connector,
                                              EndpointGroupId groupId, L2BridgeDomainId bridgeDomainId) {
        ...
        endpointBuilder.setL2Context(bridgeDomainId);
        endpointBuilder.setEndpointGroup(groupId);

        // Augment node connector
        OfOverlayContextBuilder ofOverlayContextBuilder = new OfOverlayContextBuilder();
        ofOverlayContextBuilder.setNodeConnectorId(new NodeConnectorId(connector));
    ...
    protected List<EndpointGroup> endpointGroups() {
    ...
    private SubjectFeatureInstances subjectFeatureInstances() {
        ...
        return builder.setClassifierInstance(ImmutableList.of(new ClassifierInstanceBuilder()
                ...
                .setParameterValue(ImmutableList.of(new ParameterValueBuilder().setName(new ParameterName("destport"))
                        ...
                        .setIntValue(6L)
                        .build()))
                .build(), new ClassifierInstanceBuilder().setName(new ClassifierName("tcp_src_80"))
    ...
    protected TenantBuilder baseTenantBuilder() {
        TenantBuilder tenantBuilder = new TenantBuilder();
        tenantBuilder.setId(tid)
                .setPolicy(new PolicyBuilder().setEndpointGroup(endpointGroups())
                        .setSubjectFeatureInstances(subjectFeatureInstances())
                        .build())
                .setForwardingContext(new ForwardingContextBuilder()
