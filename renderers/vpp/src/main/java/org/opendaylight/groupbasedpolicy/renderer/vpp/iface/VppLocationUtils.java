...
public class VppLocationUtils {
    ...
    static ProviderAddressEndpointLocationKey createProviderAddressEndpointLocationKey(
            AddressEndpointWithLocationKey key) {
        return new ProviderAddressEndpointLocationKey(key.getAddress(), key.getAddressType(), key.getContextId(),
                key.getContextType());
    }

    static ProviderAddressEndpointLocationKey createProviderAddressEndpointLocationKey(ParentEndpointKey key) {
        return new ProviderAddressEndpointLocationKey(key.getAddress(), key.getAddressType(), key.getContextId(),
                key.getContextType());
    }

    static VppEndpointKey vppEndpointKeyFrom(AddressEndpointKey key) {
        return new VppEndpointKey(key.getAddress(), key.getAddressType(), key.getContextId(), key.getContextType());
    }

    static VppEndpointKey vppEndpointKeyFrom(ParentEndpointKey key) {
        return new VppEndpointKey(key.getAddress(), key.getAddressType(), key.getContextId(), key.getContextType());
    }

    static VppEndpointKey vppEndpointKeyFrom(ChildEndpointKey key) {
        return new VppEndpointKey(key.getAddress(), key.getAddressType(), key.getContextId(), key.getContextType());
    }

    static ProviderAddressEndpointLocation createAbsoluteLocationFromVppEndpoint(VppEndpoint vppEndpoint) {
   ...
   public static ProviderAddressEndpointLocationKey createProviderAddressEndpointLocationKey(VppEndpoint vpp) {
    ...
    static ProviderAddressEndpointLocation createRelativeAddressEndpointLocation(@Nonnull AddressEndpointKey addrEp,
    ...
    static ProviderAddressEndpointLocation createRelativeAddressEndpointLocation(ProviderAddressEndpointLocationKey key,
            List<VppEndpoint> vppEndpoints) {
        ...
        RelativeLocations relativeLocations = new RelativeLocationsBuilder().setExternalLocation(extLocations).build();
        return new ProviderAddressEndpointLocationBuilder().setRelativeLocations(relativeLocations).setKey(key).build();
    }

    static boolean hasMultipleParents(AddressEndpoint addressEndpoint) {
        return (addressEndpoint != null
                && EndpointUtils.getParentEndpoints(addressEndpoint.getParentEndpointChoice()).size() > 1);
    }
